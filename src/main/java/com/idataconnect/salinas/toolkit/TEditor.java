...
import com.idataconnect.salinas.toolkit.texteditor.Document;
import com.idataconnect.salinas.toolkit.texteditor.Line;
import com.idataconnect.salinas.toolkit.texteditor.Word;
...
public class TEditor extends TWidget implements EditMenuUser {
     ...
     */
    /**
     * Move the display cursor to the current document cursor position.
     */
