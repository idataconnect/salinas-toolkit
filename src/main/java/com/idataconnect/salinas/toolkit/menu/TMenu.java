...
public class TMenu extends TWindow {
    ...
    public TMenu(final TApplication parent, final int x, final int y,
        ...
        if (System.getProperty("com.idataconnect.salinas.toolkit.menuIcons", "true").equals("false")) {
            useIcons = false;
        }
        ...
        try {
            opacity = Integer.parseInt(System.getProperty(
                "com.idataconnect.salinas.toolkit.TMenu.opacity", "95"));
     ...
     * null to use the value from com.idataconnect.salinas.toolkit.TMenu.borderStyle.
     */
    @Override
    public void setBorderStyleForeground(final String borderStyle) {
        if (borderStyle == null) {
            String style = System.getProperty("com.idataconnect.salinas.toolkit.TMenu.borderStyle",
                "single");
