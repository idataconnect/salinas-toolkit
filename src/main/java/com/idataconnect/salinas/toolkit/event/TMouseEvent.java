...
public class TMouseEvent extends TInputEvent {
     ...
     * @see com.idataconnect.salinas.toolkit.TWidget#onMouseDown(TMouseEvent mouse)
     * @see com.idataconnect.salinas.toolkit.TWidget#onMouseDown(TMouseEvent mouse)
     * @see com.idataconnect.salinas.toolkit.TWidget#onMouseMotion(TMouseEvent mouse)
     */
