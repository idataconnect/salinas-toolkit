...
public class SwingTerminal extends LogicalScreen
    ...
    private int[] backBufferData = null;
     ...
     * not visible.
     */
    private Map<ComplexCell, int[]> glyphCacheBlink;
    ...
    public void reloadOptions() {
        ...
        if (System.getProperty("com.idataconnect.salinas.toolkit.Swing.tripleBuffer",
                "true").equals("true")
        ) {
        ...
        setMouseStyle(System.getProperty("com.idataconnect.salinas.toolkit.Swing.mouseStyle", "default"));

        if (System.getProperty("com.idataconnect.salinas.toolkit.Swing.imagesOverText",
                "true").equals("false")) {
        ...
        String textBlinkStr = System.getProperty("com.idataconnect.salinas.toolkit.Swing.textBlink",
            "on").toLowerCase();
        ...
        // com.idataconnect.salinas.toolkit.textBlink overrides all
        if (System.getProperty("com.idataconnect.salinas.toolkit.textBlink",
                "on").toLowerCase().equals("off")
        ) {
            textBlinkOption = BlinkOption.OFF;
        }

        String cursorBlinkStr = System.getProperty("com.idataconnect.salinas.toolkit.Swing.cursorBlink",
            "on").toLowerCase();
        ...
        // com.idataconnect.salinas.toolkit.cursorBlink overrides all
        if (System.getProperty("com.idataconnect.salinas.toolkit.cursorBlink",
                "on").toLowerCase().equals("off")
        ) {
            cursorBlinkOption = BlinkOption.OFF;
        }
        ...
        long millis = 500;
        try {
            String milliStr = System.getProperty("com.idataconnect.salinas.toolkit.blinkMillis", "500");
     ...
     * Set the cursor style.
     *
     * @param style the new cursor style integer
     */
    @Override
    public void setCursorStyle(final int style) {
        switch (style) {
        case Screen.CURSOR_STYLE_BLINKING_BLOCK:
        case Screen.CURSOR_STYLE_STEADY_BLOCK:
            setCursorStyle(CursorStyle.BLOCK);
            break;
        case Screen.CURSOR_STYLE_BLINKING_UNDERLINE:
        case Screen.CURSOR_STYLE_STEADY_UNDERLINE:
            setCursorStyle(CursorStyle.UNDERLINE);
            break;
        case Screen.CURSOR_STYLE_BLINKING_BAR:
        case Screen.CURSOR_STYLE_STEADY_BAR:
            setCursorStyle(CursorStyle.VERTICAL_BAR);
            break;
        }
    }
    ...
    private static void setCustomSystemColors() {
        synchronized (SwingTerminal.class) {
            MYBLACK   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color0", MYBLACK);
            MYRED     = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color1", MYRED);
            MYGREEN   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color2", MYGREEN);
            MYYELLOW  = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color3", MYYELLOW);
            MYBLUE    = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color4", MYBLUE);
            MYMAGENTA = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color5", MYMAGENTA);
            MYCYAN    = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color6", MYCYAN);
            MYWHITE   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color7", MYWHITE);
            MYBOLD_BLACK   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color8", MYBOLD_BLACK);
            MYBOLD_RED     = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color9", MYBOLD_RED);
            MYBOLD_GREEN   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color10", MYBOLD_GREEN);
            MYBOLD_YELLOW  = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color11", MYBOLD_YELLOW);
            MYBOLD_BLUE    = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color12", MYBOLD_BLUE);
            MYBOLD_MAGENTA = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color13", MYBOLD_MAGENTA);
            MYBOLD_CYAN    = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color14", MYBOLD_CYAN);
            MYBOLD_WHITE   = getCustomColor("com.idataconnect.salinas.toolkit.Swing.color15", MYBOLD_WHITE);
        }
    }
    ...
    public static Color attrToForegroundColor(final CellAttributes attr) {
        ...
        if (attr.isBold()) {
            if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.BLACK)) {
                return MYBOLD_BLACK;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.RED)) {
                return MYBOLD_RED;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.BLUE)) {
                return MYBOLD_BLUE;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.GREEN)) {
                return MYBOLD_GREEN;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.YELLOW)) {
                return MYBOLD_YELLOW;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.CYAN)) {
                return MYBOLD_CYAN;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.MAGENTA)) {
                return MYBOLD_MAGENTA;
            } else if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.WHITE)) {
                return MYBOLD_WHITE;
            }
        } else {
            if (attr.getForeColor().equals(com.idataconnect.salinas.toolkit.bits.Color.BLACK)) {
    ...
    public static Color attrToBackgroundColor(final CellAttributes attr) {
        ...
        if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.BLACK)) {
            return MYBLACK;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.RED)) {
            return MYRED;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.BLUE)) {
            return MYBLUE;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.GREEN)) {
            return MYGREEN;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.YELLOW)) {
            return MYYELLOW;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.CYAN)) {
            return MYCYAN;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.MAGENTA)) {
            return MYMAGENTA;
        } else if (attr.getBackColor().equals(com.idataconnect.salinas.toolkit.bits.Color.WHITE)) {
            return MYWHITE;
        }
        throw new IllegalArgumentException("Invalid color: " +
    ...
    private void getFontAdjustments() {
        ...
        chars[0] = com.idataconnect.salinas.toolkit.bits.GraphicsChars.SINGLE_BAR;
        gr2.drawChars(chars, 0, 1, gr2x, gr2y + fontTextHeight - maxDescent);
        chars[0] = com.idataconnect.salinas.toolkit.bits.GraphicsChars.VERTICAL_BAR;
        gr2.drawChars(chars, 0, 1, gr2x, gr2y + fontTextHeight - maxDescent);
        gr2.dispose();
    ...
    private void drawGlyph(final BufferedImage tempBuffer,
        ...
        if (!cell.isBlink()
            ...
            if (ImageUtils.canDrawUnicodeBlockDrawingChar(ch)) {
                ...
                ImageUtils.drawUnicodeBlockDrawingChar(ch, foreColor,
                    backColor, tempBuffer);
                pixels = ((DataBufferInt) tempBuffer.getRaster().getDataBuffer()).getData();
            }
        }
        ...
        if (pixels == null) {
            if (cell.isBlink() && !cursorBlinkVisible
                ...
                pixels = glyphCacheBlink.get(cell);
            } else {
        ...
        if (cell.isEmoji()
            ...
            int emjWidth = newImage.getWidth();
            int[] newPixels = new int[emjWidth * textHeight];
        ...
        if (useGlyphMaker) {
            ...
            int gw = newImage.getWidth();
            int[] newPixels = new int[gw * textHeight];
        ...
        if ((SwingComponent.tripleBuffer) && (swing.getFrame() != null)) {
            ...
            int [] tempPixels = ((DataBufferInt) tempBuffer.getRaster().getDataBuffer()).getData();
            int[] clonePixels = tempPixels.clone();

            if (!cell.isImage()) {
                cacheCellPixels(cell, clonePixels);
            }
    ...
    private void blitToScreen(int xPixel, int yPixel, int[] pixels, int pWidth) {
        if (backBufferData == null || backBuffer == null) return;
        int screenWidth = backBuffer.getWidth();
        int screenHeight = backBuffer.getHeight();
        if (xPixel < 0 || yPixel < 0 || xPixel + pWidth > screenWidth || yPixel + textHeight > screenHeight) {
             return;
        }
        for (int y = 0; y < textHeight; y++) {
            System.arraycopy(pixels, y * pWidth, backBufferData, (yPixel + y) * screenWidth + xPixel, pWidth);
        }
    }
     ...
     */
    private void cacheCellPixels(final Cell cell, final int[] pixels) {
        ...
        if (cell.isCacheable()) {
            ...
            if (cell.isBlink() && !cursorBlinkVisible
                ...
                glyphCacheBlink.put(key, pixels);
            } else {
                if (glyphCache.size() > MAX_GLYPH_CACHE_SIZE) {
                    glyphCache.clear();
                }
                glyphCache.put(key, pixels);
            }
        }
    }
    ...
    private void drawCursor(final Graphics gr) {
        ...
        case BLOCK:
            ...
            // Draw the character over the block using background color
            ComplexCell cursorCell = new ComplexCell(logical[cursorX][cursorY]);
            cursorCell.setForeColorRGB(attrToBackgroundColor(cell).getRGB());
            cursorCell.setBackColorRGB(attrToForegroundColor(cell).getRGB());
            drawGlyph(glyphBuffer, gr, cursorCell, xPixel, yPixel);
            break;
        case OUTLINE:
    ...
    public void paint(final Graphics gr) {
        ...
        if (bWidth <= 0 || bHeight <= 0) {
             bWidth = Math.max(1, width * textWidth);
             bHeight = Math.max(1, height * textHeight);
        }
        if (backBuffer == null || backBuffer.getWidth() != bWidth || backBuffer.getHeight() != bHeight) {
            backBuffer = new BufferedImage(bWidth, bHeight, BufferedImage.TYPE_INT_ARGB);
        ...
        */
        ...
        synchronized (this) {
            for (int y = 0; y < height; y++) {
                if (!dirtyRows[y] && !reallyCleared) {
                    // Quick check for cursor or blinking on this row
                    if (y != cursorY) {
                         boolean hasDynamic = false;
    ...
    public void componentResized(final ComponentEvent event) {
        ...
        // Update top/left insets
        java.awt.Insets insets = swing.getInsets();
    ...
    public void runPerformanceTests(final java.io.PrintStream out) {
        ...
        cell.setForeColor(com.idataconnect.salinas.toolkit.bits.Color.BLUE);
        cell.setBold(true);
        cell.setBackColor(com.idataconnect.salinas.toolkit.bits.Color.CYAN);
