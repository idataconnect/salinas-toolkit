...
import com.idataconnect.salinas.toolkit.bits.MathUtils;
import com.idataconnect.salinas.toolkit.terminal.SixelDecoder;
...
public class HQSixelEncoder implements SixelEncoder {
    ...
    public void reloadOptions() {
        ...
        try {
            paletteSize = Integer.parseInt(System.getProperty(
                "com.idataconnect.salinas.toolkit.ECMA48.sixelPaletteSize", "128"));
            switch (paletteSize) {
            case 2:
            case 4:
            case 8:
        ...
        String customPaletteStr = System.getProperty("com.idataconnect.salinas.toolkit.ECMA48.sixelCustomPalette",
            "none").toLowerCase();
        ...
        String emitPaletteStr = System.getProperty("com.idataconnect.salinas.toolkit.ECMA48.sixelEmitPalette",
            "true").toLowerCase();
    ...
    public static void main(final String [] args) {
        if ((args.length == 0)
            ...
            System.err.println("USAGE: java com.idataconnect.salinas.toolkit.backend.HQSixelEncoder [ -p | -t | -v | -vv ] [ -vt340 | -cga ] { file1 [ file2 ... ] }");
            System.exit(-1);
        }
