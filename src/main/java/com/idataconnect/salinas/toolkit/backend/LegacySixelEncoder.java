...
public class LegacySixelEncoder implements SixelEncoder {
    ...
    public void reloadOptions() {
        ...
        try {
            paletteSize = Integer.parseInt(System.getProperty(
                "com.idataconnect.salinas.toolkit.ECMA48.sixelPaletteSize", "1024"));
            switch (paletteSize) {
            case 2:
            case 256:
            case 512:
        ...
        // Shared palette
        if (System.getProperty("com.idataconnect.salinas.toolkit.ECMA48.sixelSharedPalette",
                "true").equals("false")) {
            sharedPalette = false;
        } else {
            sharedPalette = true;
    ...
    public static void main(final String [] args) {
        if (args.length == 0) {
            System.err.println("USAGE: java com.idataconnect.salinas.toolkit.backend.LegacySixelEncoder [ -v | -vv | -t | -p ] { file1 [ file2 ... ] }");
            System.exit(-1);
        }
