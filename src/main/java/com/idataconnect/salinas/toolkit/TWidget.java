...
import com.idataconnect.salinas.toolkit.layout.LayoutManager;
...
public abstract class TWidget implements Comparable<TWidget> {
     ...
     * The cursor style.
     */
    private int cursorStyle = Screen.CURSOR_STYLE_DEFAULT;
     ...
     */
    public final int getCursorStyle() {
        return cursorStyle;
    }
    ...
    public final void drawChildren() {
        ...
        if (window != null && window.isMinimized() && (this instanceof TWindow)) {
            // Do not draw children of a minimized window
            return;
        }
