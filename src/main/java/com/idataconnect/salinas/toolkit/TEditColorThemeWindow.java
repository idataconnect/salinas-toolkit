...
public class TEditColorThemeWindow extends TWindow {
    ...
    class ForegroundPicker extends TWidget {
        ...
        public void draw() {
            ...
            borderStyle = BorderStyle.getStyle(System.getProperty(
                "com.idataconnect.salinas.toolkit.TEditColorTheme.options.borderStyle", "single"));
     ...
     * null to use the value from com.idataconnect.salinas.toolkit.TEditColorTheme.borderStyle.
     */
    @Override
    public void setBorderStyleForeground(final String borderStyle) {
        if (borderStyle == null) {
            String style = System.getProperty("com.idataconnect.salinas.toolkit.TEditColorTheme.borderStyle",
                "double");
