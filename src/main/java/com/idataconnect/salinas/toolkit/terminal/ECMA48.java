...
import com.idataconnect.salinas.toolkit.io.ReadTimeoutException;
import com.idataconnect.salinas.toolkit.io.TimeoutInputStream;
...
public class ECMA48 implements Runnable {
     ...
     * device type.  Note that com.idataconnect.salinas.toolkit.TTerminal pulls TERM from the System
     * property com.idataconnect.salinas.toolkit.TTerminal.TERM, rather than using on the value here.
     *
    ...
    private void xtversion() {
        ...
        if (type == DeviceType.XTERM) {
            if (i == 0) {
                // DCS > | {text} ST
                if (s8c1t == true) {
                    writeRemote("\u0090>|com.idataconnect.salinas.toolkit(" + VERSION + ")\u009c");
                } else {
                    writeRemote("\033P>|com.idataconnect.salinas.toolkit(" + VERSION + ")\033\\");
                }
            }
        }
    }
        ...
        for (int i = 0; i < namesHex.length; i++) {
            ...
            if (name.toString().equals("TN")) {
                writeXtgettcapResponse(name.toString(),
                    System.getProperty("com.idataconnect.salinas.toolkit.TTerminal.TERM",
                        "xterm-direct"));
            }
